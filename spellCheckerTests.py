...
class test_spellChecker(unittest.TestCase):
    ...
    def test_getWordSuggestionsV2(self):
        ...
        #tests for known word that matches
        self.assertEqual(["exist"], getWordSuggestionsV2("existt", "test_dictionary.txt", 1, 2))
        self.assertEqual(["they"], getWordSuggestionsV2("thy", "test_dictionary.txt", 1, 2))
    ...
    def test_getCombinedWordSuggestions(self):
        #checks for expected outcome#self.assertEqual(["Appelfrate"], getCombinedWordSuggestions("Appleplate", "test_dictionary_2.txt"))
        ...
        self.assertEqual(["exist"], getCombinedWordSuggestions("existt", "test_dictionary.txt"))
        self.assertEqual(["they"], getCombinedWordSuggestions("thy", "test_dictionary.txt"))
unittest.main()
