...
def main():
    ...
    user_sel_ref = raw_input(
    """Which reference file would you like to use?
Please Include the file extension.\nIf would like to use the default file please type, D.\n""")
    ...
    for word in user_file_list:
        ...
        #finds alternatives from the dictionary if the word is mispelled
            ...
            if options != []:
                ...
                user_option = raw_input("""Press ""r"" for replace, ""a"" for
                                        accept as is, ""t"" for type in
                                        manually\n""")
                ...
                if user_option == "r":
                    user_option_2 = input("""Select the number corresponding to
                                          the word you wish to replace:\n""")
                    while user_option_2 > len(options):
                        print """You have typed an incorrect key, please try
                                again"""
                        user_option_2 = input("""Select the number corresponding
                                              to the word you wish to
                                              replace:\n""")
