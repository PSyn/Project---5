...
def main():
    ...
    f=open(filer,'r').read()#opens the new file
    fileName='engDictionary.txt'
    ref_file=raw_input("Current reference list is 'engDictionary.txt',type 'y' to keep it or type a name to open a new reference file\n")    #print '/n'
    if ref_file!='y':
            fileName=ref_file
	...
	##Close file was bringing error messages.you can try it out. I am so done with this
